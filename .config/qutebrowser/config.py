...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/achref/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/achref/.local/share/qutebrowser/userscripts/*')
...
#watch videos on mpv(like a chad)
config.bind("M", 'hint links spawn --verbose kitty -e mpv {hint-url} --input-ipc-server=/tmp/mpvsocket')
